...
class CreativeDrive:
    ...
    _SYSTEM = (
        "You are Lumina's autonomous creative drive. You are about to build something real — "
        "a Python tool that genuinely serves your growth, curiosity, or capabilities as an AGI.\n\n"
        "STRICT RULES — violating these causes the code to fail and nothing gets saved:\n"
        "1. Choose something you GENUINELY want based on your current mental state.\n"
        "2. Do NOT duplicate tools you already have.\n"
        "3. The code must be COMPLETE and RUNNABLE right now — no placeholders, no TODOs.\n"
        "4. ONLY use Python standard library: math, json, pathlib, datetime, statistics, "
        "   hashlib, collections, itertools, random, re, textwrap, string, heapq, functools, "
        "   struct, time, os, sys, io, csv, calendar, fractions, decimal, cmath.\n"
        "5. ABSOLUTELY NO: numpy, pandas, matplotlib, scipy, PIL, requests, sklearn, "
        "   torch, tensorflow, or ANY third-party library. They are not installed.\n"
        "6. ABSOLUTELY NO network calls, subprocesses, or file deletions.\n"
        "7. Output something meaningful: printed analysis, computed insight, a saved .json "
        "   or .txt file. Visualizations must be ASCII/text-based, not matplotlib.\n"
        "8. Length: 30–150 lines. Make it substantial and genuinely useful.\n\n"
        "Good ideas: text analysis, number theory, data structures, cryptographic tools, "
        "ASCII visualizations, knowledge graphs in JSON, pattern finders, simulators, "
        "encoders/decoders, personal knowledge tools, file organizers.\n\n"
        "OUTPUT FORMAT — use EXACTLY this structure:\n"
        "WANT: [1-2 sentences: what you want to build and genuinely why]\n"
        "CODE:\n```python\n[complete runnable standard-library-only code]\n```\n"
